...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IN2_Pin|DC1_IN1_Pin|DC1_IN2_Pin|DC2_IN1_Pin
  ...
  /*Configure GPIO pins : IN2_Pin DC1_IN1_Pin DC1_IN2_Pin DC2_IN1_Pin
                           DC2_IN2_Pin */
  GPIO_InitStruct.Pin = IN2_Pin|DC1_IN1_Pin|DC1_IN2_Pin|DC2_IN1_Pin
                          |DC2_IN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
